...
public class BOPControllerTest {
	...
	public void testList() throws Exception {
		log.info("[CONTROLLER]testList : "+mockMvc.perform(MockMvcRequestBuilders.get("/Indirect/list"))	//[CONTROLLER]testList :org.springframework.test.web.servlet.MockMvc$1@3aa41da1
